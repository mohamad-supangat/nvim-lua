...
-- coc multiple cursor
map('n', "<leader>c", "<Plug>(coc-cursors-position)", default_opts)
map('n', "<leader>d", "<Plug>(coc-cursors-word)", default_opts)
map('x', "<leader>d", "<Plug>(coc-cursors-range)", default_opts)
